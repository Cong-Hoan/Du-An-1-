...
public class QuanLyTaiKhoanJInternal extends javax.swing.JInternalFrame {
    ...
    public boolean ValidateForm() {
        if (txtMaNhanVien.getText().isEmpty() || txtTenTK.getText().isEmpty() || txtMatKhau.getText().isEmpty()
                || rdoNhanVien.getText().isEmpty() || rdoTruongPhong.getText().isEmpty())  {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (txtTenTK.getText().equals("")) {
            ...
            txtTenTK.setBackground(Color.red);
        } else {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        if (txtMaNhanVien.getText().isEmpty()) {
            ...
            int x = JOptionPane.showConfirmDialog(this, "Bạn chắc chắn muốn xóa?");
    ...
    private void tblTaiKhoanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTaiKhoanMouseClicked
        try {
            ...
            TaiKhoan tk = dao.getTaiKhoanByID(manv);
            setModel(tk);
        } catch (Exception e) {
    ...
    private void btnSeachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeachActionPerformed
        if (txtMaNhanVien.getText().isEmpty()) {
            ...
            TaiKhoan tk = dao.getTaiKhoanByID(txtMaNhanVien.getText());
            if (tk != null) {
